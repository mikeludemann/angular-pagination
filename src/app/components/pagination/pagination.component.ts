...
export class PaginationComponent implements OnInit {
	...
	@ViewChild('pag', {static: false}) el: ElementRef;
			...
			function Pagination() {
				...
				prevButton.style.display = "none";
					...
					let selectedPage = function() {
						let page_number: any = document.getElementById('page_number').getElementsByClassName('clickPageNumber'); 
